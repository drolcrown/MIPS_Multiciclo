...
signal out_mux_signed	: std_logic_vector(WORD_SIZE-1 downto 0);
signal out_mux_iLB	: std_logic_vector(WORD_SIZE-1 downto 0); -- Saida MUX Tipo LOAD			
signal out_mux_iLH	: std_logic_vector(WORD_SIZE-1 downto 0); -- Saida MUX Tipo LOAD			
signal out_toReg 	    : std_logic_vector(WORD_SIZE-1 downto 0); 
signal out_mod4 	    : std_logic_vector(1 downto 0); -- Divisor para recuperar o resto da divisao de lb
signal out_mux_toReg	: std_logic_vector(1 downto 0);
signal sel_mux_signal	: std_logic;
...
--=======================================================================
-- Mux de selecao de dado seleção tipo unsigned ou signed
--=======================================================================					 
signal_mux_loads: mux_2_signed
		generic map (SIZE => 32)
		port map (in0 => out_mux_signed,
					 in1 => out_mux_signed,
					 sel => sel_mux_signal,
					 m_out => out_toReg);

--=======================================================================
-- Mux de selecao de dado para instrução
--=======================================================================					 
	iL_data_mux: mux_3 
		generic map (W_SIZE => 32)
		port map (	in0 => regdata_v,
					in1 => out_mux_iLB,
					in2 => out_mux_iLH,
					sel => out_mux_toReg,
					m_out => out_mux_signed);

--=======================================================================
-- Mux de selecao de dado para instrução Half Word
--=======================================================================						 
	iLH_data_mux: mux_4_lh
		generic map (W_SIZE => 32)
		port map (	in0 => regdata_v,
				in1 => regdata_v,
				in2 => regdata_v,
...
--=======================================================================
-- Mux de selecao de dado para instrução load Byte
--=======================================================================					 
	iLB_data_mux: mux_4_lb
		generic map (W_SIZE => 32)
		port map (	in0 => regdata_v,
					in1 => regdata_v,
					in2 => regdata_v,
...
ctr_mips: mips_control
		port map (	
			...
			wr_breg	=> reg_wr_s,
			s_reg_add => reg_dst_s,
			iLoad_signal => sel_mux_signal,
			out_mux_toReg => out_mux_toReg
		);
